...
<?php include '../models/material.php'; ?>
...
<html lang="es">
  <head>
    ...
    <!-- Bootstrap CSS -->
    <!-- <link href="../libs/bootstrap.min.css" rel="stylesheet" integrity="sha384-giJF6kkoqNQ00vy+HMDP7azOuL0xtbfIcaT9wjKHr8RbDVddVHyTfAAsrekwKmP1" crossorigin="anonymous"> -->
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="../udemy/img/slides/santorini1.jpg" class="d-block w-100" alt="...">
    ...
    <div class="carousel-item">
      <img src="../udemy/img/slides/florencia.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block caja2" >
    ...
    <div class="carousel-item">
      <img src="../udemy/img/slides/venecia.jpg" class="d-block w-100" alt="...">
      <div class="carousel-caption d-none d-md-block caja2">
